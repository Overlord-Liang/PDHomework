...
void DragableTabGroup::slotStartDrag(int index)
{
    ...
    mime->setData(DRAGABLE_TAB_WINDOW_MIME_KEY, QString::number(reinterpret_cast<long long>(this)).toUtf8());
    mime->setData(DRAGABLE_TAB_WIDGET_MIME_KEY, QString::number(reinterpret_cast<long long>(dragging_widget)).toUtf8());
